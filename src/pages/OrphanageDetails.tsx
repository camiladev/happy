...
export default function OrphanageDetails() {
  ...
  //route.params recebe os parametros enviados pela pagina anterior
  ...
  function handleOpenGoogleMapRoutes() {
    ...
    //colocando o ? antes do ponto ele verifica se a variavel não esta vazia
    Linking.openURL(`https://www.google.com/maps/dir/?api=1&destination=${orphanage?.latitude},${orphanage?.longitude}`);
  }

  function contactWithWhattsApp(){
    Linking.openURL(`http://api.whatsapp.com/send?phone=55${orphanage?.contact}`);
  }
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <RectButton style={styles.contactButton} onPress={contactWithWhattsApp}>
